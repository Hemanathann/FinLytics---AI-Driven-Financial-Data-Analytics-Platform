...
const KNOWN_SUBS = [
  ...
  // Added for Irish users / common subscriptions
...
export function DashboardClient({ accounts, transactions, savingsGoals, subscriptionData, netWorthData, budgetVsActual, budgetData }) {
  ...
  // Subscriptions: search description only (cleanName not stored in DB)
  // Also check category==="bills" for known subscription merchants
